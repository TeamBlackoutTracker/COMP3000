...
public class CandidateView extends View {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        // SK add image view
        ImageView image = (ImageView) MyKeyboard.imageview;
        int width = image.getWidth();
        int height = image.getHeight();
        int parentWidth = MeasureSpec.getSize(widthMeasureSpec - width);
        ...
        setMeasuredDimension(parentWidth, resolveSize(height, heightMeasureSpec));
    }
